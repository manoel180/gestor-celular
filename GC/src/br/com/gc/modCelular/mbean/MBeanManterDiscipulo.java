...
//        }  
	...
	public void setListEstadoCivis(List<EstadoCivil> listEstadoCivis) {
		this.listEstadoCivis = listEstadoCivis;
	}

	public List<FormacaoAcademica> getListFormacaoAcademicas() {
		return listFormacaoAcademicas;
	}

	public void setListFormacaoAcademicas(
			List<FormacaoAcademica> listFormacaoAcademicas) {
		this.listFormacaoAcademicas = listFormacaoAcademicas;
	}
