...
import br.com.gc.presentation.util.MBeanPesquisar;
import br.com.gc.seguranca.entity.Usuario;
import br.com.gc.seguranca.service.SegurancaService;

/**
 * @author manoel
 */
@Controller("mBeanPesquisarDiscipulo")
@Scope("request")
public class MBeanPesquisarDiscipulo extends MBeanPesquisar {
	...
	private List<Discipulos> list;
	private List<Usuario> usuarios;

	@Override
	@PostConstruct
	public void inicializar() {
		setList(new ArrayList<Discipulos>());
	...
	public void pesquisar() {
		setUsuarios(segurancaService.listarTodosUsuarios());
	}
	 ...
	 * @return
	 */
	public List<Discipulos> getList() {
		return list;
	}

	public void setList(List<Discipulos> list) {
		this.list = list;
	}
	...
	// private Formacaoeclesiasticas formacaoeclesiastica = new
	// Formacaoeclesiasticas();
	// private FuncaoEclesiasticas funcaoeclesiasticas = new
	// FuncaoEclesiasticas();
	// private ApplicationSecurityManager discipuloSessao = new
	// ApplicationSecurityManager();
	//
	// // Objetos Daos
	// private FuncaoeclesiasticasDao funcaoeclesiasticasDao = new
	// FuncaoeclesiasticasDaoImp();
	// byte[] conteudo;
	// String path;
	//
	//
	// private List<Formacaoeclesiasticas> ListaFormacoesEclesiasticas = new
	// ArrayList<Formacaoeclesiasticas>();
	// private List<FuncaoEclesiasticas> listaFuncaoEclesiasticas = new
	// ArrayList<FuncaoEclesiasticas>();
	// private DualListModel<Formacaoeclesiasticas> ListaFormacaoEclesiasticas =
	// new DualListModel<Formacaoeclesiasticas>();
	// private DualListModel<Encontros> ListaEncontros = new
	// DualListModel<Encontros>();
	...
	//
	// private List<Formacaoeclesiasticas> sourceFormacaoEclesiasticas = new
	// ArrayList<Formacaoeclesiasticas>();
	// private List<Formacaoeclesiasticas> targetFormacaoEclesiasticas = new
	// ArrayList<Formacaoeclesiasticas>();
	//
	// private Formacaoeclesiasticas[] SelecaoFormacoesEclesiasticas;
	// private Encontros[] SelecaoEncontros;
	//
	// private FormacaoeclesiasticasDao formacaoeclesiasticasDao = new
	// FormacaoeclesiasticasDaoImp();
	...
	// private List<Discipulos> listaDiscipulosGeracoes = new
	// ArrayList<Discipulos>();
	// private ArvoreGeracoesNodos arvoreGeracoesNodos = new
	// ArvoreGeracoesNodos();
	// private List<ArvoreGeracoesNodos> indexGeracoesNodos = new
	// ArrayList<ArvoreGeracoesNodos>();
	//
	// // Buscar pelo cep
	...
	// listDiscipulosConjuges = discipuloDao.listarDiscipulosCasados(query,
	// discipuloSessao.getDiscipulos().getDisSexo());
	...
	// listaDiscipulosGeracoes =
	// discipuloSessao.getDiscipulos().getDiscipuloses();
	//
	...
	// }
	//
	// public int montarArvoreGeracaoMovimentoPai(Discipulos discipulo, Geracoes
	// geracao){
	...
	// sourceFormacaoEclesiasticas.addAll(new
	// FormacaoeclesiasticasDaoImp().todos());
	// source.addAll(new EncontrosDaoImp().todos());
	//
	// funcaoeclesiasticas = new FuncaoEclesiasticas();
	// geracoes = new Geracoes();
	//
	// ListaFormacaoEclesiasticas = new
	// DualListModel<Formacaoeclesiasticas>(sourceFormacaoEclesiasticas,
	// targetFormacaoEclesiasticas);
	...
	// }
	//
	// discipulos.setDisSenha(new
	// Criptografia().criptografar(discipulos.getDisSenha()));
	// discipulos.setDisSexo(discipuloSessao.getDiscipulos().getDisSexo());
	// //discipulos.setEncontroses(ListaEncontros.getTarget());
	// discipulos.setFormacaoeclesiasticases(ListaFormacaoEclesiasticas.getTarget());
	// //discipulos.setDiscipulos(discipuloSessao.getDiscipulos());
	...
	// */
	// public void setFormacaoeclesiastica(Formacaoeclesiasticas
	// formacaoeclesiastica) {
	...
	// InputStream stream = this.getClass().getResourceAsStream(
	// "/br/com/pais/util/sem_foto.jpg");
	// return imagem = new DefaultStreamedContent(stream, "image/jpeg",
	// "sem_foto");
	// }else {
	// return imagem;
	// }
	...
	// */
	// public DualListModel<Formacaoeclesiasticas>
	// getListaFormacaoEclesiasticas() {
	...
	// */
	// public void
	// setListaFormacaoEclesiasticas(DualListModel<Formacaoeclesiasticas>
	// listaFormacaoEclesiasticas) {
	...
	// */
	// public void setFuncaoeclesiasticas(FuncaoEclesiasticas
	// funcaoeclesiasticas) {
	...
	// */
	// public void setListaFuncaoEclesiasticas(List<FuncaoEclesiasticas>
	// listaFuncaoEclesiasticas) {
	...
	// */
	// public void setListDiscipulosConjuges(List<Discipulos>
	// listDiscipulosConjuges) {
	...
	// }
	//
	// public void setListaDiscipulosGeracoes(List<Discipulos>
	// listaDiscipulosGeracoes) {
	...
	// }
	//
	// public void setArvoreGeracoesNodos(ArvoreGeracoesNodos
	// arvoreGeracoesNodos) {
	...
	// }
	//
	// public void setIndexGeracoesNodos(List<ArvoreGeracoesNodos>
	// indexGeracoesNodos) {
